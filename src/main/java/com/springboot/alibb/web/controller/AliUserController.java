...
public class AliUserController extends BaseController {
     ...
     * @return
     */
    @RequestMapping("/getAliUserList.json")
    public String getAliUserList(HttpServletRequest request, AliUserVo aliUserVo) {
...
//            subjectRecordVo.setBrowserInfo(this.getBrowserInfo(request));
            ...
            return aliUserVo.getCallback() + "(" + JSONUtil.parseArray(iAliUserService.getAliUserList(aliUserVo)).toString() + ")";
